...
public class FindDetailResult implements FindService {
    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        ArrayList<MusicDTO> findArtist = new MusicDAO().findDetailArtist(findInput);
        ArrayList<MusicDTO> findAlbum = new MusicDAO().findDetailAlbum(findInput);
