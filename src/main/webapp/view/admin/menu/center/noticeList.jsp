...
<div id=adminUrl>
  <form style=" background: white;">
    ...
    <table style="border-collapse: collapse; width: 100%;" >
      <h1 class="nav navbar-text justify-content-center"><b>공지사항</b></h1>
      <br>
      ...
      <div class="btn-group" style="display: flex; margin: auto; width: 60%;">
        ...
        <a class="btn" href="AdminCenterFAQ?FAQKind=FAQList" style="width: 10%; background: rebeccapurple; color: honeydew; "><h5 style="line-height: inherit;">FAQ</h5></a>
      ...
      <tr>
        <th colspan="11">
          <a class="btn btn col-md-4" style="background:mediumpurple; color:honeydew;" href="AdminCenter?noticeKind=noticeInsert"><h5 style="line-height: inherit;">등록</h5></a>
        </th>
      </tr>
      </tfoot>
    </table>
